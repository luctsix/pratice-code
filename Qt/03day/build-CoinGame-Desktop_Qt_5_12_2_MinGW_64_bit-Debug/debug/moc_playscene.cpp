...
QT_MOC_LITERAL(1, 10, 15), // "backChooseScene"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "PlayScene\0backChooseScene\0"
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->backChooseScene(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::backChooseScene)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlayScene::backChooseScene()
{
